                        ...
                        <div class="tabcontentstyledd top0">
                                <div id="tcontent14">
                                    <div>
                                       ...
                                       <div class="tjkc"><a onclick="openDiv()"><font size="+2">+</font>添加基础课程</a></div> 
                                       
<!-- 弹出框 start --> 
      
      
      <div id="winDiv">
        <div class="topDiv"><span class="fl">添加基础课程</span><span class="fr" id="close" onclick="closeDiv()"><img src="images/close.jpg" /></span><div class="clear"></div></div>
        <div class="condiv">
          <p class="condiv_p">
             年级：&nbsp;&nbsp;<label><select style="width:100px;"><option>高一</option></select></label>&nbsp;&nbsp;&nbsp;&nbsp;科目&nbsp;&nbsp;<label><select style="width:100px;"><option>物理</option></select></label><br />
             线上价格：&nbsp;&nbsp;<input type="text" value="25.00" class="condiv_ipt"/>&nbsp;元/半小时&nbsp;&nbsp;<input name="" type="checkbox" value="" /><br />
             线下价格：&nbsp;&nbsp;<input type="text" value="25.00" class="condiv_ipt"/>&nbsp;元/半小时&nbsp;&nbsp;<input name="" type="checkbox" value="" /><br />
             
          </p>
          <div style="vertical-align:top; padding-left:30px;">备注：<textarea name="" cols="" rows="" class="condiv_tex">其它说明（0-200字）</textarea></div>
...
<!-- 弹出框 stop --> 
                                    ...
                                    <div>
                                        <div class="incwdddcona">
                                            ...
                                            <div class="incwdddcona2" style="width: 50px;">
                                                学院
                                            </div>
                                            <div class="incwdddcona2" style="width: 50px;">
                                                课程
                                       ...
                                       <div class="tjkc"><a onclick="openDiv1()"><font size="+2">+</font>添加基础课程</a></div> 
                                          
                                          
                                                                          
                                    </div>
    <div id="winDiv1">
        <div class="topDiv"><span class="fl">添加基础课程</span><span class="fr" id="close" onclick="closeDiv1()"><img src="images/close.jpg" /></span><div class="clear"></div></div>
        <div class="condiv">
          <p class="condiv_p">
             学校：&nbsp;&nbsp;<label><select style="width:100px;"><option>北交</option></select></label>&nbsp;&nbsp;&nbsp;&nbsp;学院：&nbsp;&nbsp;<label><select style="width:100px;"><option>计算机</option></select></label><br />
             专业：&nbsp;&nbsp;<label><select style="width:100px;"><option>计算机</option></select></label>&nbsp;&nbsp;&nbsp;&nbsp;课程：&nbsp;&nbsp;<label><select style="width:100px;"><option>操作系统</option></select></label><br />
             线上价格：&nbsp;&nbsp;<input type="text" value="25.00" class="condiv_ipt"/>&nbsp;元/半小时&nbsp;&nbsp;<input name="" type="checkbox" value="" /><br />
             线下价格：&nbsp;&nbsp;<input type="text" value="25.00" class="condiv_ipt"/>&nbsp;元/半小时&nbsp;&nbsp;<input name="" type="checkbox" value="" /><br />
